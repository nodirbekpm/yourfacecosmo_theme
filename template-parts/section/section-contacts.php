...
<section class="contacts">
    <div class="container">
        ...
        <div class="contact-row">
            ...
            <div class="contact-ratings">
                ...
                <div class="other-ratings">
                    <a href="<?php echo esc_url(get_field('review_2gis.ru', 'option')) ?>">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/icons/2gis.png" alt="">
                        Отзывы на 2gis.ru
                    </a>
                    <a href="<?php echo esc_url(get_field('review_zoon', 'option')) ?>">
        ...
        <div class="payment_terms">
            ...
            <a target="_blank" href="/wp-content/uploads/2025/08/predoplata.pdf" class="payment-btn">
                ПОДРОБНЕЕ
